<template>
  <div class="weather">
    <div class="weather-overlay1">
      ...
      <div  class="w-max">️↑ <span style="font-weight: bold"> 15</span></div>
      <div  class="w-min">↓ <span style="font-weight: bold"> 9</span></div>
      <div class="w-wind-icon">
<!--        <img src='../assets/wind1.png'>-->
        <img src='../assets/wind2.png'>
      </div>
      <div class="w-wind-gust">
        <p ><span  style="font-weight: 600;">7.33</span><span> m/s</span></p>
      </div>
      <div class="wind-speed">
        <p><span  style="font-weight: 600;">19</span><span> Km/Hr</span></p>
      </div>
      <div class="weather-time">
        <p>⏰ Current hour:</p>
        <p style="font-weight: 500">• 16/24</p>
      </div>
