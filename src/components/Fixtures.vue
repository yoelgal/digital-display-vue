...
<!--I assume emoji can be changed depending one sport-->
        <div class="sport"><span style="position:relative;top: 2vh;overflow: hidden" >⚽</span>️</div>
        <div class="team"><span style="opacity: 0.5;font-weight: 200">Team: </span><span style="display: block;font-size: 2vh">Boys-U10A</span></div>
        <div class="line"></div>
        <div class="date">Sun 17 Feb</div>
        <div class="opposition"><span style="opacity: 0.5;font-weight: 200">Opposition: </span><span style="display: block;font-size:2vh;width: 20vw;">University College School (UCS)</span></div>
      </div>
    </div>
